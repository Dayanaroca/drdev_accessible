 ...
 */
  ...
  ?>
<section aria-labelledby="viaja-mejor-heading"  class="w-auto lg:w-full max-w-[1100px] mx-2.5 lg:mx-auto border-b-2 border-b-secondary">
    <h2 id="viaja-mejor-heading" class="font-bold text-4xl text-left leading-[3.375rem] mb-5 ml-0 lg:ml-8">
