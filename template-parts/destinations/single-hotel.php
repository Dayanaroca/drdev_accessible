...
<section class="flex flex-col gap-5 w-full max-w-screen-etg mx-auto px-2.5 lg:px-0">
    ...
    <div class="flex flex-row gap-4">
       <?php get_template_part( 'template-parts/destinations/content', 'location', ['travel' => $travel,]);
            get_template_part( 'template-parts/destinations/content', 'startsHotel', ['travel' => $travel,]);
             get_template_part( 'template-parts/destinations/content', 'visibility', ['travel' => $travel,]);?>
    </div>
    ...
    <div class="hidden lg:block">
         <?php get_template_part( 'template-parts/destinations/content', 'accessibleFor', ['travel' => $travel,]);?>
    </div>
    ...
    <?php get_template_part( 'template-parts/destinations/content', 'facilidades', ['travel' => $travel,]);?>
 ...
 <?php 
    ...
    if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) :
        ...
        $args = [
            'post_type'      => 'viajes',
            'posts_per_page' => 3, // máximo 3 hoteles
        ...
        if ( $related_hotels->have_posts() ) : ?>
            <section class="w-full max-w-screen-etg mx-auto px-2.5 lg:px-0">
                <h2 class="font-bold text-2xl lg:text-3xl text-black mb-5 text-center">
                    <?php esc_html_e( 'Otros hoteles accesibles que pueden interesarte', 'drdevcustomlanguage' ); ?>
                </h2>
                <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    while ( $related_hotels->have_posts() ) :
                        ...
                        get_template_part( 'template-parts/travel/cards/card', 'hotel', ['travel' => $related_travel] );
                    endwhile;
                    ?>
                </div>
            </section>
