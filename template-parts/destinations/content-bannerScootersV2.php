<?php
/**
 * Template part for displaying banners scooters v2 content
 *
...
<section id="cita-banner-scooters" class="relative w-full  max-w-screen-etg mx-auto px-2.5 lg:px-0 rounded-custom">
    ...
    <div class="flex flex-col items-center lg:items-end gap-4 lg:gap-2 justify-end p-6 lg:p-8 w-full lg:w-[48rem]">
        ...
        <p class="text-white text-base md:text-2xl font-medium text-center lg:text-right tracking-[0.045rem]">
            <span class="font-black"><?php esc_html_e( 'Scooters accesibles', 'drdevcustomlanguage' ); ?></span>
            <?php esc_html_e( 'para que te desplaces cómodamente y sin preocupaciones.', 'drdevcustomlanguage' ); ?>
        </p>
